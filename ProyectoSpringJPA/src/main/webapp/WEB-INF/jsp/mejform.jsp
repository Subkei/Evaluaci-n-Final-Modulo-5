...
<html lang="en">
  <head>
    ...
    <title>Agregar  Mejora</title>
  </head>
  <body>
    <div class="jumbotron">
        <header class="text-center">
            <h2>Agregar  Mejora</h2>
        </header>
    </div> 
     <form:form method="post" action="mejsave" modelAttribute="mejora">
          ...
          <br><br><br>
           <div class="row">
               ...
               <a class="btn btn-warning col-4" href="viewmej" role="button">Volver</a>
                &nbsp;&nbsp;&nbsp;&nbsp;
               <input type="submit" class="btn btn-warning col-4" value="Agregar Mejora">
               </div>
           </div>          
        </div>
      </form:form> 
